...
ENABLE_DOCLING_SERVICE="$(env_get ENABLE_DOCLING_SERVICE "false")"
ENABLE_DOCLING_GPU="$(env_get ENABLE_DOCLING_GPU "false")"
ENABLE_DOCLING_UI="$(env_get ENABLE_DOCLING_UI "false")"
DOCLING_MAX_CONCURRENT="$(env_get DOCLING_MAX_CONCURRENT "2")"
CELERY_CONCURRENCY_FAST="$(env_get CELERY_CONCURRENCY_FAST "6")"
CELERY_CONCURRENCY_HEAVY="$(env_get CELERY_CONCURRENCY_HEAVY "2")"
CELERY_CONCURRENCY_INTEGRATIONS="$(env_get CELERY_CONCURRENCY_INTEGRATIONS "4")"
...
CELERY_CONCURRENCY_FAST=${CELERY_CONCURRENCY_FAST}
CELERY_CONCURRENCY_HEAVY=${CELERY_CONCURRENCY_HEAVY}
CELERY_CONCURRENCY_INTEGRATIONS=${CELERY_CONCURRENCY_INTEGRATIONS}
...
# Determine Docling URL: embedded container when enabled, empty otherwise
...
# Map boolean to Docling's expected 0/1
if [[ "${ENABLE_DOCLING_UI}" == "true" ]]; then
...
DOCLING_TIMEOUT=300
DOCLING_VERIFY_SSL=false
DOCLING_MAX_CONCURRENT=${DOCLING_MAX_CONCURRENT}
