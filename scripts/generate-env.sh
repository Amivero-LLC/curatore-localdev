...
SALESFORCE_DOMAIN="$(env_get SALESFORCE_DOMAIN)"
SALESFORCE_CONSUMER_KEY="$(env_get SALESFORCE_CONSUMER_KEY)"
SALESFORCE_CONSUMER_SECRET="$(env_get SALESFORCE_CONSUMER_SECRET)"
WEB_SEARCH_ENGINE="$(env_get WEB_SEARCH_ENGINE)"
GOOGLE_PSE_API_KEY="$(env_get GOOGLE_PSE_API_KEY)"
GOOGLE_PSE_ENGINE_ID="$(env_get GOOGLE_PSE_ENGINE_ID)"
EBUY_USERNAME="$(env_get EBUY_USERNAME)"
EBUY_PASSWORD="$(env_get EBUY_PASSWORD)"
EBUY_OKTA_AUTH_SERVER_ID="$(env_get EBUY_OKTA_AUTH_SERVER_ID)"
EBUY_OKTA_CLIENT_ID="$(env_get EBUY_OKTA_CLIENT_ID)"
...
# OAuth / SSO
AUTH_MODE="$(env_get AUTH_MODE "basic")"
OAUTH_MS_TENANT_ID="$(env_get OAUTH_MS_TENANT_ID)"
OAUTH_MS_CLIENT_ID="$(env_get OAUTH_MS_CLIENT_ID)"
OAUTH_MS_CLIENT_SECRET="$(env_get OAUTH_MS_CLIENT_SECRET)"
OAUTH_SCOPES="$(env_get OAUTH_SCOPES "openid email profile")"
OAUTH_AUTO_PROVISION="$(env_get OAUTH_AUTO_PROVISION "true")"
OAUTH_MERGE_ACCOUNTS_BY_EMAIL="$(env_get OAUTH_MERGE_ACCOUNTS_BY_EMAIL "true")"
ENABLE_OAUTH_ROLE_MANAGEMENT="$(env_get ENABLE_OAUTH_ROLE_MANAGEMENT "true")"
OAUTH_ROLES_CLAIM="$(env_get OAUTH_ROLES_CLAIM "roles")"
OAUTH_ADMIN_ROLES="$(env_get OAUTH_ADMIN_ROLES "admin")"
OAUTH_ALLOWED_ROLES="$(env_get OAUTH_ALLOWED_ROLES)"
OAUTH_DEFAULT_ROLE="$(env_get OAUTH_DEFAULT_ROLE "member")"
ENABLE_OAUTH_GROUP_MANAGEMENT="$(env_get ENABLE_OAUTH_GROUP_MANAGEMENT "false")"
OAUTH_GROUP_CLAIM="$(env_get OAUTH_GROUP_CLAIM "groups")"
OAUTH_GROUP_ORG_MAP="$(env_get OAUTH_GROUP_ORG_MAP)"
